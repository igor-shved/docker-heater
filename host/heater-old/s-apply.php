...
$valGetNewNoDechex = $num . ";" . $vals[1] . ";" . $vals[2] * 10 . ";" . $vals[3] . ";" . $vals[4] . ";0:";
...
for ($i = 0; $i < $len - 2; $i++) {
    ...
    $scheduleNoDechex = $scheduleNoDechex . $d . ";";
}
...
//savelog(['$valGetNew'=>$valGetNew, '$schedule'=>$schedule]);
//savelog(['$valGetNewNoDechex'=>$valGetNewNoDechex]);
